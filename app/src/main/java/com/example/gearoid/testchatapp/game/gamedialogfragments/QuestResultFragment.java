...
public class QuestResultFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        revealCardLabel = (TextView) rootView.findViewById(R.id.textView_RevelCardLabel);

        String leaderText = "";
        if(isLeader){
            leaderText = " - Leader";
        } else {
            revealCardLabel.setText("Waiting For " + Session.allPlayers.get(GameLogicFunctions.getCurrentLeaderID()).userName + " (The Leader) To Reveal Cards");
        }
