...
//            gameStatusText = "View Character";
    ...
    public void setAllButtonsGone() {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Log.d("GameActivity", "runOnUiThread: setting all buttons invisible (not View Character)");
